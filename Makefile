#############################################################################
# Makefile for building: CacheFlowSim.app/Contents/MacOS/CacheFlowSim
# Generated by qmake (3.1) (Qt 6.9.0)
# Project:  CacheFlowSim.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile CacheFlowSim.pro
#############################################################################
...
CXXFLAGS      = -pipe -stdlib=libc++ -O2 -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.0.sdk -mmacosx-version-min=14.0 -Wall -Wextra $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = CacheFlowSim1.0.0
DISTDIR = /Users/nicoledsouza/Downloads/535isaproj-main/.tmp/CacheFlowSim1.0.0
...
SOURCES       = SimulatorWindow.cpp \
		main.cpp moc_SimulatorWindow.cpp
OBJECTS       = SimulatorWindow.o \
		main.o \
		moc_SimulatorWindow.o
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		CacheFlowSim.pro SimulatorWindow.h SimulatorWindow.cpp \
		main.cpp
QMAKE_TARGET  = CacheFlowSim
DESTDIR       = 
TARGET        = CacheFlowSim.app/Contents/MacOS/CacheFlowSim

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 14.0
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Applications/Xcode.app/Contents/Developer
EXPORT__QMAKE_STASH_ = /Users/nicoledsouza/Downloads/535isaproj-main/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/nicoledsouza/Downloads/535isaproj-main/CacheFlowSim.pro
...
CacheFlowSim.app/Contents/MacOS/CacheFlowSim:  $(OBJECTS)  
	@test -d CacheFlowSim.app/Contents/MacOS/ || mkdir -p CacheFlowSim.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: CacheFlowSim.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile CacheFlowSim.pro
...
CacheFlowSim.app/Contents/PkgInfo: 
	@test -d CacheFlowSim.app/Contents || mkdir -p CacheFlowSim.app/Contents
	@$(DEL_FILE) CacheFlowSim.app/Contents/PkgInfo
	@echo "APPL????" > CacheFlowSim.app/Contents/PkgInfo
CacheFlowSim.app/Contents/Info.plist: 
	@test -d CacheFlowSim.app/Contents || mkdir -p CacheFlowSim.app/Contents
	@$(DEL_FILE) CacheFlowSim.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.CacheFlowSim,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.CacheFlowSim,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,CacheFlowSim,g" -e "s,@LIBRARY@,CacheFlowSim,g" -e "s,\$${EXECUTABLE_NAME},CacheFlowSim,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >CacheFlowSim.app/Contents/Info.plist

all: Makefile \
		CacheFlowSim.app/Contents/PkgInfo \
		CacheFlowSim.app/Contents/Info.plist CacheFlowSim.app/Contents/MacOS/CacheFlowSim
...
distdir: FORCE
	...
	$(COPY_FILE) --parents SimulatorWindow.h $(DISTDIR)/
	$(COPY_FILE) --parents SimulatorWindow.cpp basicsimulator.cpp memoryUI.cpp main.cpp $(DISTDIR)/
...
moc_predefs.h: /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp
	/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++ -pipe -stdlib=libc++ -O2 -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.0.sdk -mmacosx-version-min=14.0 -Wall -Wextra -dM -E -o moc_predefs.h /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: moc_SimulatorWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_SimulatorWindow.cpp
moc_SimulatorWindow.cpp: SimulatorWindow.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/nicoledsouza/Downloads/535isaproj-main/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/nicoledsouza/Downloads/535isaproj-main -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.0.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/15.0.0/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.0.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib SimulatorWindow.h -o moc_SimulatorWindow.cpp
...
SimulatorWindow.o: SimulatorWindow.cpp SimulatorWindow.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QMainWindow \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qmainwindow.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QPushButton \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qpushbutton.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SimulatorWindow.o SimulatorWindow.cpp
...
moc_SimulatorWindow.o: moc_SimulatorWindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_SimulatorWindow.o moc_SimulatorWindow.cpp
